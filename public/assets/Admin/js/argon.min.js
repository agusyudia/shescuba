...
function sidebarType(e) {
    ...
    for (var o, r, c, d = document.querySelector(".sidenav"), s = 0; s < l.length; s++) d.classList.remove(l[s]);
...
function darkMode(e) {
    ...
    if (e.getAttribute("checked")) {
        t.classList.remove("dark-version"), n.classList.add("bg-white"), x.includes("logo-ct.png") && (S = x.replace("logo-ct", "logo-ct-dark"), w.src = S);
        for (k = 0; k < L.length; k++) L[k].classList.contains("text-dark") && (L[k].classList.add("text-white"), L[k].classList.remove("text-dark"));
        for (k = 0; k < a.length; k++) a[k].classList.contains("light") && (a[k].classList.add("dark"), a[k].classList.remove("light"));
        for (k = 0; k < l.length; k++) l[k].classList.contains("light") && (l[k].classList.add("dark"), l[k].classList.remove("light"));
        for (k = 0; k < s.length; k++) s[k].classList.contains("text-white") && (s[k].classList.remove("text-white"), s[k].classList.add("text-dark"));
        for (k = 0; k < r.length; k++) !r[k].classList.contains("text-white") || r[k].closest(".sidenav") || r[k].closest(".card.bg-gradient-dark") || (r[k].classList.remove("text-white"), r[k].classList.add("text-dark"));
        for (k = 0; k < d.length; k++) d[k].classList.contains("text-white") && (d[k].classList.remove("text-white"), d[k].classList.add("text-dark"));
        for (k = 0; k < g.length; k++) g[k].classList.contains("text-white") && (g[k].classList.remove("text-white"), g[k].classList.remove("opacity-8"), g[k].classList.add("text-dark"));
        for (k = 0; k < v.length; k++) v[k].classList.contains("bg-gray-600") && (v[k].classList.remove("bg-gray-600"), v[k].classList.add("bg-gray-100"));
        for (k = 0; k < p.length; k++) p[k].hasAttribute("fill") && p[k].setAttribute("fill", "#252f40");
        for (k = 0; k < h.length; k++) h[k].closest(".card.bg-gradient-dark") || (h[k].classList.remove("text-white"), h[k].classList.add("text-dark"));
        for (k = 0; k < y.length; k++) y[k].classList.remove("border-dark");
        e.removeAttribute("checked")
    } else {
        var S;
        t.classList.add("dark-version"), x.includes("logo-ct-dark.png") && (S = x.replace("logo-ct-dark", "logo-ct"), w.src = S);
        for (var k = 0; k < a.length; k++) a[k].classList.contains("dark") && (a[k].classList.remove("dark"), a[k].classList.add("light"));
        for (var k = 0; k < l.length; k++) l[k].classList.contains("dark") && (l[k].classList.remove("dark"), l[k].classList.add("light"));
        for (var k = 0; k < s.length; k++) s[k].classList.contains("text-dark") && (s[k].classList.remove("text-dark"), s[k].classList.add("text-white"));
        for (var k = 0; k < o.length; k++) o[k].classList.contains("text-dark") && (o[k].classList.remove("text-dark"), o[k].classList.add("text-white"));
        for (var k = 0; k < c.length; k++) c[k].classList.contains("text-dark") && (c[k].classList.remove("text-dark"), c[k].classList.add("text-white"));
        for (var k = 0; k < u.length; k++) u[k].classList.contains("text-dark") && (u[k].classList.remove("text-dark"), u[k].classList.add("text-white"));
        for (var k = 0; k < g.length; k++) g[k].classList.contains("text-secondary") && (g[k].classList.remove("text-secondary"), g[k].classList.add("text-white"), g[k].classList.add("opacity-8"));
        for (var k = 0; k < m.length; k++) m[k].classList.contains("bg-gray-100") && (m[k].classList.remove("bg-gray-100"), m[k].classList.add("bg-gray-600"));
        for (var k = 0; k < f.length; k++) f[k].classList.remove("text-dark"), f[k].classList.add("text-white");
        for (var k = 0; k < i.length; k++) i[k].classList.remove("bg-white");
        for (var k = 0; k < p.length; k++) p[k].hasAttribute("fill") && p[k].setAttribute("fill", "#fff");
        for (var k = 0; k < b.length; k++) b[k].classList.add("border-dark");
